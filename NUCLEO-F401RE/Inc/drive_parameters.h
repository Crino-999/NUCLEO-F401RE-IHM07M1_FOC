...
#define MAX_APPLICATION_SPEED_RPM           2502 /*!< rpm, mechanical */
...
#define PID_TORQUE_KP_DEFAULT               2627
#define PID_TORQUE_KI_DEFAULT               2622
#define PID_TORQUE_KD_DEFAULT               100
#define PID_FLUX_KP_DEFAULT                 2627
#define PID_FLUX_KI_DEFAULT                 2622
...
#define PID_SPEED_KP_DEFAULT                2881/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT                48/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define DEFAULT_TARGET_SPEED_RPM            901
#define DEFAULT_TARGET_SPEED_UNIT           (DEFAULT_TARGET_SPEED_RPM*SPEED_UNIT/U_RPM)
#define DEFAULT_TORQUE_COMPONENT_A          0
#define DEFAULT_FLUX_COMPONENT_A            0

/**************************    FIRMWARE PROTECTIONS SECTION   *****************/
#define OV_VOLTAGE_THRESHOLD_V              14.7 /*!< Over-voltage threshold */
...
/* Phase 2 */
#define PHASE2_DURATION                     2002 /*milliseconds */
#define PHASE2_FINAL_SPEED_UNIT             (1001*SPEED_UNIT/U_RPM)
#define PHASE2_FINAL_CURRENT_A              2

/* Phase 3 */
#define PHASE3_DURATION                     0 /*milliseconds */
#define PHASE3_FINAL_SPEED_UNIT             (1001*SPEED_UNIT/U_RPM)
#define PHASE3_FINAL_CURRENT_A              2

/* Phase 4 */
#define PHASE4_DURATION                     0 /*milliseconds */
#define PHASE4_FINAL_SPEED_UNIT             (1001*SPEED_UNIT/U_RPM)
#define PHASE4_FINAL_CURRENT_A              2

/* Phase 5 */
#define PHASE5_DURATION                     0 /* milliseconds */
#define PHASE5_FINAL_SPEED_UNIT             (1001*SPEED_UNIT/U_RPM)
...
#define OBS_MINIMUM_SPEED_RPM               901
...
#define M1_CONSTANT1_Q                      68158
#define M1_CONSTANT1_D                      68158
#define M1_CONSTANT2_QD                     12009

/* **** Potentiometer parameters **** */
/** @brief Sampling time set to the ADC channel used by the potentiometer component */
#define POTENTIOMETER_ADC_SAMPLING_TIME_M1  LL_ADC_SAMPLING_CYCLE(28)
